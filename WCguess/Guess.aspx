<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="Guess.aspx.cs" Inherits="WCguess.Guess" ClientIDMode="Static" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnApostar').click(function () {
                if (CheckAllFields()) {
                    if (confirm('Ao apostar, não será possivel alterar as mais os chutes, TEM CERTEZA QUE DESEJA APOSTAR?')) {
                        return true;
                    }
                }
                return false;
            ...
            <td valign="top">
                <div>
                    <h2 class="page-subtitle">
                        Quantos pontos você faz?</h2>
                    <asp:Button CssClass="btn-opaco" ID="btnGuardarResultado" runat="server" Text="guardar resultado"
                        OnClick="btnGuardarResultado_Click" />
                    <asp:Button CssClass="btn-opaco" ID="btnApostar" runat="server" Text="apostar" OnClick="btnApostar_Click" />
                </div>
            </td>
            <td>
                <div class="div-grupo">
                    <table style="width: 100%; padding: 0;" id="tbGrupoA" cellpadding="0" cellspacing="0" runat="server">
                        <tr>
        ...
        <div id="t4">
                ...
                <div class="team ks-1A">
                    <asp:TextBox ID="txtJogo48Time1" data-tc="NG" data-rank="1A" runat="server" /><span
                        ...
                        <div class="flag-24 flag-24-NG">
                            <asp:Image ID="ImgJogo48Time1" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                ...
                <div class="team ks-2B">
                    <asp:TextBox ID="txtJogo48Time2" data-tc="PT" data-rank="2B" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-PT">
                            <asp:Image ID="ImgJogo48Time2" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                                Width="24px" runat="server" />
                        </div>
                    </span>
                ...
                <div class="team ks-1C">
                    <asp:TextBox ID="txtJogo49Time1" data-tc="AR" data-rank="1C" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-AR">
                            <asp:Image ID="ImgJogo49Time1" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                ...
                <div class="team ks-2D">
                    <asp:TextBox ID="txtJogo49Time2" data-tc="GR" data-rank="2D" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-GR">
                            <asp:Image ID="ImgJogo49Time2" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                                Width="24px" runat="server" /></div>
                    </span>
                ...
                <div class="team ks-1E">
                    <asp:TextBox ID="txtJogo50Time1" data-tc="NL" data-rank="1E" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-NL">
                            <asp:Image ID="ImgJogo50Time1" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                                Width="24px" runat="server" /></div>
                    </span>
                ...
                <div class="team ks-2F">
                    <asp:TextBox ID="txtJogo50Time2" data-tc="AU" data-rank="2F" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-AU">
                            <asp:Image ID="ImgJogo50Time2" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                                Width="24px" runat="server" /></div>
                    </span>
                ...
                <div class="team ks-1G">
                    <asp:TextBox ID="txtJogo51Time1" data-tc="DZ" data-rank="1G" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-DZ">
                            <asp:Image ID="ImgJogo51Time1" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                                Width="24px" runat="server" /></div>
                    </span>
                ...
                <div class="team ks-2H">
                    <asp:TextBox ID="txtJogo51Time2" data-tc="UY" data-rank="2H" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-UY">
                            <asp:Image ID="ImgJogo51Time2" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                                Width="24px" runat="server" /></div>
                    </span>
                ...
                <div class="team ks-1B">
                    <asp:TextBox ID="txtJogo52Time1" data-tc="CI" data-rank="1B" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-CI">
                            <asp:Image ID="ImgJogo52Time1" runat="server" Height="24px" ImageUrl="~/Styles/Images/flags/Default.png"
                                Width="24px" />
                        </div>
                    </span>
                ...
                <div class="team ks-2A">
                    <asp:TextBox ID="txtJogo52Time2" data-tc="HR" data-rank="2A" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-HR">
                            <asp:Image ID="ImgJogo52Time2" runat="server" Height="24px" ImageUrl="~/Styles/Images/flags/Default.png"
                                Width="24px" />
                        </div>
                    </span>
                ...
                <div class="team ks-1D">
                    <asp:TextBox ID="txtJogo53Time1" data-tc="CR" data-rank="1D" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-CR">
                            <asp:Image ID="ImgJogo53Time1" runat="server" Height="24px" ImageUrl="~/Styles/Images/flags/Default.png"
                                Width="24px" />
                        </div>
                    </span>
                ...
                <div class="team ks-2C">
                    <asp:TextBox ID="txtJogo53Time2" data-tc="BA" data-rank="2C" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-BA">
                            <asp:Image ID="ImgJogo53Time2" runat="server" Height="24px" ImageUrl="~/Styles/Images/flags/Default.png"
                                Width="24px" />
                        </div>
                    </span>
                ...
                <div class="team ks-1F">
                    <asp:TextBox ID="txtJogo54Time1" data-tc="ES" data-rank="1F" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-ES">
                            <asp:Image ID="ImgJogo54Time1" runat="server" Height="24px" ImageUrl="~/Styles/Images/flags/Default.png"
                                Width="24px" />
                        </div>
                    </span>
                ...
                <div class="team ks-2E">
                    <asp:TextBox ID="txtJogo54Time2" data-tc="EC" data-rank="2E" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-EC">
                            <asp:Image ID="ImgJogo54Time2" runat="server" Height="24px" ImageUrl="~/Styles/Images/flags/Default.png"
                                Width="24px" />
                        </div>
                    </span>
                ...
                <div class="team ks-1H">
                    <asp:TextBox ID="txtJogo55Time1" data-tc="_england" data-rank="1H" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-_england">
                            <asp:Image ID="ImgJogo55Time1" runat="server" Height="24px" ImageUrl="~/Styles/Images/flags/Default.png"
                                Width="24px" />
                        </div>
                    </span>
                ...
                <div class="team ks-2G">
                    <asp:TextBox ID="txtJogo55Time2" data-tc="RU" data-rank="2G" runat="server" /><span
                        class="f"><div class="flag-24 flag-24-RU">
                            <asp:Image ID="ImgJogo55Time2" runat="server" Height="24px" ImageUrl="~/Styles/Images/flags/Default.png"
                                Width="24px" />
                        </div>
                    </span>
            ...
            <div class="ks ks-qf ks-1A2B1C2D rtxt" title="Quarter-finals">
                ...
                <div class="team ks-1A2B-w">
                    <asp:Image ID="ImgJogo56Time1" Style="margin-left: 35px; float: left" ImageUrl="~/Styles/Images/flags/Default.png"
                ...
                <div class="team ks-C ks-D ks-1C2D-w">
                    <asp:Image ID="ImgJogo56Time2" Style="margin-left: 35px; float: left" ImageUrl="~/Styles/Images/flags/Default.png"
                        Height="24px" Width="24px" runat="server" />
            ...
            <div class="ks ks-qf ks-1E2F1G2H rtxt" title="Quarter-finals">
                ...
                <div class="team ks-1E2F-w">
                    <asp:Image ID="ImgJogo58Time1" Style="margin-left: 35px; float: left" ImageUrl="~/Styles/Images/flags/Default.png"
                        Height="24px" Width="24px" runat="server" />
                    <asp:TextBox ID="txtJogo58Time1" data-rank="1A2B" runat="server" Style="float: left;
                        margin-left: 5px;"></asp:TextBox><span class="f"></span></div>
                <div class="team ks-G ks-H ks-1G2H-w">
                    <asp:Image ID="ImgJogo58Time2" Style="margin-left: 35px; float: left" ImageUrl="~/Styles/Images/flags/Default.png"
                        Height="24px" Width="24px" runat="server" />
            ...
            <div class="ks ks-qf ks-1B2A1D2C ltxt" title="Quarter-finals">
                ...
                <div class="team ks-1B2A-w">
                    ...
                    <asp:Image ID="ImgJogo57Time1" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                        Width="24px" runat="server" />
                    <span class="f"></span>
                </div>
                <div class="team ks-1B2A-w">
                    <asp:TextBox ID="txtJogo57Time2" data-rank="1B2A" runat="server"> </asp:TextBox>
                    <asp:Image ID="ImgJogo57Time2" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                        Width="24px" runat="server" />
                    <span class="f"></span>
                </div>
            </div>
            <div class="ks ks-qf ks-1F2E1H2G ltxt" title="Quarter-finals">
                ...
                <div class="team ks-1B2A-w">
                    ...
                    <asp:Image ID="ImgJogo59Time1" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                        Width="24px" runat="server" />
                    <span class="f"></span>
                </div>
                <div class="team ks-1B2A-w">
                    <asp:TextBox ID="txtJogo59Time2" data-rank="1B2A" runat="server"> </asp:TextBox>
                    <asp:Image ID="ImgJogo59Time2" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                        Width="24px" runat="server" />
                    <span class="f"></span>
                </div>
            </div>
            <div class="ks ks-sf ks-1A2B1C2D1E2F1G2H rtxt" title="Semi-finals">
                ...
                <div class="rtxt team ks-1A2B1C2D-w">
                    <asp:Image ID="ImgJogo60Time1" Style="margin-left: 35px; float: left" ImageUrl="~/Styles/Images/flags/Default.png"
                        Height="24px" Width="24px" runat="server" />
                    <asp:TextBox ID="txtJogo60Time1" data-rank="1A2B" runat="server" Style="float: left;
                        margin-left: 5px;"> </asp:TextBox><span class="f"></span></div>
                <div class="rtxt team ks-1E2F1G2H-w">
                    <asp:Image ID="ImgJogo60Time2" Style="margin-left: 35px; float: left" ImageUrl="~/Styles/Images/flags/Default.png"
                        Height="24px" Width="24px" runat="server" />
            ...
            <div class="ks ks-sf ks-1B2A1D2C1F2E1H2G ltxt" title="Semi-finals">
                ...
                <div class="team ks-1B2A-w">
                    ...
                    <asp:Image ID="ImgJogo61Time1" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                        Width="24px" runat="server" />
                    <span class="f"></span>
                </div>
                <div class="team ks-1B2A-w">
                    <asp:TextBox ID="txtJogo61Time2" data-rank="1B2A" runat="server"> </asp:TextBox>
                    <asp:Image ID="ImgJogo61Time2" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                        Width="24px" runat="server" />
                    <span class="f"></span>
                </div>
            </div>
            <div class="ks ks-3RD" style="margin: 0; padding: 0;" title="Match for third place">
                <center>
                    <b><a style="font-size: 16px; margin: 0; padding: 0;">Terceiro lugar</a></b></center>
                <table width="100%" style="color: Black">
                    <tr>
                        <td align="right">
                            <asp:Label ID="lblJogo62Time1" runat="server" Text="Label" CssClass="n"></asp:Label>
                        </td>
                        <td align="center">
                            <asp:Image ID="ImgJogo62Time1" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                                Width="24px" runat="server" />
                        </td>
                        <td align="right">
                        ...
                        <td align="center">
                            <asp:Image ID="ImgJogo62Time2" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                                Width="24px" runat="server" />
                        </td>
                        <td align="left">
            ...
            <div class="ks ks-FINAL ks-1A2B1C2D1E2F1G2H1B2A1D2C1F2E1H2G" title="Final">
                <%--<h2 style="padding:0; margin:0">
                    Final</h2>--%>
                <center>
                    <b><a style="font-size: 16px; margin: 0; padding: 0;">Final</a></b></center>
                <table width="100%" style="color: Black;">
                    <tr>
                        <td align="right">
                            <asp:Label ID="lblJogo63Time1" runat="server" Text="Label"></asp:Label>
                        </td>
                        <td align="center">
                            <asp:Image ID="ImgJogo63Time1" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                                Width="24px" runat="server" />
                        </td>
                        <td align="right">
                        ...
                        <td align="center">
                            <asp:Image ID="ImgJogo63Time2" ImageUrl="~/Styles/Images/flags/Default.png" Height="24px"
                                Width="24px" runat="server" />
                        </td>
                        <td align="left">
                            <asp:Label ID="lblJogo63Time2" runat="server" Text="Label" CssClass="n"></asp:Label>
                        </td>
                    </tr>
                </table>
                <div class="dt">
    ...
    <asp:HiddenField ID="HdnImgJogo48Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo48Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo49Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo49Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo50Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo50Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo51Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo51Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo52Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo52Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo53Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo53Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo54Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo54Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo55Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo55Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo56Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo56Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo57Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo57Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo58Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo58Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo59Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo59Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo60Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo60Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo61Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo61Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo62Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo62Time2" runat="server" />
    <asp:HiddenField ID="HdnImgJogo63Time1" runat="server" />
    <asp:HiddenField ID="HdnImgJogo63Time2" runat="server" />
</asp:Content>
