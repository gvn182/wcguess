...
namespace WCguess
{
    public partial class Guess : System.Web.UI.Page
    {
        ...
        private void LoadInformation()
        {
            ...
            bool TemDefinitivo = BLO_Jogo.TemDefinitivo(ID_Usuario);
        ...
        private void DisableAllFields()
        {
            ...
            btnGuardarResultado.Visible = false;
        }
        ...
        private void SaveOitavas(bool TemJogo)
        {
            ...
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 48, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo48Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo48Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo48Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo48Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 49, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo49Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo49Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo49Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo49Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 50, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo50Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo50Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo50Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo50Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 51, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo51Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo51Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo51Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo51Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 52, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo52Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo52Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo52Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo52Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 53, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo53Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo53Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo53Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo53Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 54, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo54Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo54Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo54Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo54Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 55, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo55Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo55Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo55Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo55Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 56, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo56Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo56Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo56Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo56Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 57, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo57Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo57Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo57Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo57Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 58, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo58Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo58Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo58Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo58Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 59, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo59Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo59Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo59Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo59Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 60, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo60Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo60Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo60Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo60Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 61, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo61Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo61Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo61Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo61Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 62, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo62Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo62Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo62Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo62Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            ListJogos.Add(new REP_JOGOS() { ID_JOGO = 63, ID_USUARIO = ID_Usuario, TIME_1 = Path.GetFileNameWithoutExtension(HdnImgJogo63Time1.Value), RESULTADO_TIME_1 = int.Parse(txtJogo63Time1.Text), TIME_2 = Path.GetFileNameWithoutExtension(HdnImgJogo63Time2.Value), RESULTADO_TIME_2 = int.Parse(txtJogo63Time2.Text), TIPO_GRAVACAO = 0, FASE = 2 });
            if (!TemJogo)
            {
        ...
        protected void btnApostar_Click(object sender, EventArgs e)
        {
            ...
            if (!TemJogo)
            {
                ...
                SaveOitavas(TemJogo);
                BLO_Jogo.SetJogosDefinitivos(ID_Usuario);
            }
            else
            {
                BLO_Jogo.SetJogosDefinitivos(ID_Usuario);
            ...
            LoadInformation();
            ClientScript.RegisterStartupScript(this.GetType(), "AlertSucessoAposta", "alert('Aposta salva com sucesso');", true);
        }
