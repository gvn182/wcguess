        ...
        <div id="t4">
            <div class="ks ks-r16 ks-1A2B rtxt" title="Round of 16">
                ...
                <div class="team ks-1A">
                    ...
                    <asp:Label ID="lblJogo48Time1" runat="server"  Text="Label"
                        CssClass="n" Style="float: right"></asp:Label></div>
                <div class="team ks-2B">
                    ...
                    <asp:Label ID="lblJogo48Time2" runat="server"  Text="Label"
                        CssClass="n" Style="float: right"></asp:Label></div>
            </div>
            <div class="ks ks-r16 ks-1C2D rtxt" title="Round of 16">
                ...
                <div class="team ks-1C">
                    ...
                    <asp:Label ID="lblJogo49Time1" runat="server"  Text="Label"
                        CssClass="n" Style="float: right"></asp:Label></div>
                <div class="team ks-2D">
                    ...
                    <asp:Label ID="lblJogo49Time2" runat="server"  Text="Label"
                        CssClass="n" Style="float: right"></asp:Label></div>
            </div>
            <div class="ks ks-r16 ks-1E2F rtxt" title="Round of 16">
                ...
                <div class="team ks-1E">
                    ...
                    <asp:Label ID="lblJogo50Time1" runat="server"  Text="Label"
                        CssClass="n" Style="float: right"></asp:Label></div>
                <div class="team ks-2F">
                    ...
                    <asp:Label ID="lblJogo50Time2" runat="server"  Text="Label"
                        CssClass="n" Style="float: right"></asp:Label></div>
            </div>
            <div class="ks ks-r16 ks-1G2H rtxt" title="Round of 16">
                ...
                <div class="team ks-1G">
                    ...
                    <asp:Label ID="lblJogo51Time1" runat="server"  Text="Label"
                        Style="float: right" CssClass="n"></asp:Label></div>
                <div class="team ks-2H">
                    ...
                    <asp:Label ID="lblJogo51Time2" runat="server"  Text="Label"
                        Style="float: right;" CssClass="n"></asp:Label></div>
            </div>
                ...
                <div class="team ks-1B">
                    <asp:TextBox ID="txtJogo52Time1" data-tc="CI" data-rank="1B" runat="server"  /><span
                        class="f"><div class="flag-24 flag-24-CI">
                            <asp:Image ID="ImgJogo52Time1" runat="server"  Height="24px"
                                ImageUrl="~/Styles/Images/flags/Argentina.png" Width="24px" />
                        </div>
                    </span>
                    <asp:Label ID="lblJogo52Time1" runat="server"  Text="Label"
                ...
                <div class="team ks-2A">
                    <asp:TextBox ID="txtJogo52Time2" data-tc="HR" data-rank="2A" runat="server"  /><span
                        class="f"><div class="flag-24 flag-24-HR">
                            <asp:Image ID="ImgJogo52Time2" runat="server"  Height="24px"
                                ImageUrl="~/Styles/Images/flags/Argentina.png" Width="24px" />
                        </div>
                    </span>
                    <asp:Label ID="lblJogo52Time2" runat="server"  Text="Label"
                        CssClass="n"></asp:Label></div>
            </div>
                ...
                <div class="team ks-1D">
                    <asp:TextBox ID="txtJogo53Time1" data-tc="CR" data-rank="1D" runat="server"  /><span
                        class="f"><div class="flag-24 flag-24-CR">
                            <asp:Image ID="ImgJogo53Time1" runat="server"  Height="24px"
                                ImageUrl="~/Styles/Images/flags/Argentina.png" Width="24px" />
                        </div>
                    </span>
                    <asp:Label ID="lblJogo53Time1" runat="server"  Text="Label"
                        CssClass="n"></asp:Label></div>
                <div class="team ks-2C">
                    <asp:TextBox ID="txtJogo53Time2" data-tc="BA" data-rank="2C" runat="server"  /><span
                        class="f"><div class="flag-24 flag-24-BA">
                            <asp:Image ID="ImgJogo53Time2" runat="server"  Height="24px"
                                ImageUrl="~/Styles/Images/flags/Argentina.png" Width="24px" />
                        </div>
                    </span>
                    <asp:Label ID="lblJogo53Time2" runat="server"  Text="Label"
                        CssClass="n"></asp:Label></div>
            </div>
                ...
                <div class="team ks-1F">
                    <asp:TextBox ID="txtJogo54Time1" data-tc="ES" data-rank="1F" runat="server"  /><span
                        class="f"><div class="flag-24 flag-24-ES">
                            <asp:Image ID="ImgJogo54Time1" runat="server"  Height="24px"
                                ImageUrl="~/Styles/Images/flags/Argentina.png" Width="24px" />
                        </div>
                    </span>
                    <asp:Label ID="lblJogo54Time1" runat="server"  Text="Label"
                        CssClass="n"></asp:Label></div>
                <div class="team ks-2E">
                    <asp:TextBox ID="txtJogo54Time2" data-tc="EC" data-rank="2E" runat="server"  /><span
                        class="f"><div class="flag-24 flag-24-EC">
                            <asp:Image ID="ImgJogo54Time2" runat="server"  Height="24px"
                                ImageUrl="~/Styles/Images/flags/Argentina.png" Width="24px" />
                        </div>
                    </span>
                    <asp:Label ID="lblJogo54Time2" runat="server"  Text="Label"
                        CssClass="n"></asp:Label></div>
            </div>
            <div class="ks ks-r16 ks-1H2G ltxt" title="Round of 16">
                ...
                <div class="team ks-1H">
                    <asp:TextBox ID="txtJogo55Time1" data-tc="_england" data-rank="1H" runat="server"
                         /><span class="f"><div class="flag-24 flag-24-_england">
                            <asp:Image ID="ImgJogo55Time1" runat="server"  Height="24px"
                                ImageUrl="~/Styles/Images/flags/Argentina.png" Width="24px" />
                        </div>
                        </span>
                    <asp:Label ID="lblJogo55Time1" runat="server"  Text="Label"
                        CssClass="n"></asp:Label></div>
                <div class="team ks-2G">
                    <asp:TextBox ID="txtJogo55Time2" data-tc="RU" data-rank="2G" runat="server"  /><span
                        class="f"><div class="flag-24 flag-24-RU">
                            <asp:Image ID="ImgJogo55Time2" runat="server"  Height="24px"
                                ImageUrl="~/Styles/Images/flags/Argentina.png" Width="24px" />
                        </div>
                    </span>
                    <asp:Label ID="lblJogo55Time2" runat="server"  Text="Label"
                        CssClass="n"></asp:Label></div>
            </div>
            <div class="ks ks-qf ks-1A2B1C2D rtxt" title="Quarter-finals">
                ...
                <div class="team ks-1A2B-w">
                    ...
                    <asp:TextBox ID="txtJogo56Time1" data-rank="1A2B" runat="server" 
                        Style="float: left; margin-left: 5px;"></asp:TextBox><span class="f"></span></div>
                <div class="team ks-C ks-D ks-1C2D-w">
                    <asp:Image ID="ImgJogo56Time2" Style="margin-left: 35px; float: left" ImageUrl="~/Styles/Images/flags/Argentina.png"
                        Height="24px" Width="24px" runat="server"  />
                    <asp:TextBox ID="txtJogo56Time2" data-rank="1A2B" runat="server" 
                        Style="float: left; margin-left: 5px;"></asp:TextBox><span class="f"></span></div>
            </div>
            <div class="ks ks-qf ks-1E2F1G2H rtxt" title="Quarter-finals">
                ...
                <div class="team ks-1E2F-w">
                    <asp:Image ID="ImgJogo58Time1" Style="margin-left: 35px; float: left" ImageUrl="~/Styles/Images/flags/Argentina.png"
                        Height="24px" Width="24px" runat="server"  />
                    <asp:TextBox ID="txtJogo58Time1" data-rank="1A2B" runat="server" 
                        Style="float: left; margin-left: 5px;"></asp:TextBox><span class="f"></span></div>
                <div class="team ks-G ks-H ks-1G2H-w">
                    <asp:Image ID="ImgJogo58Time2" Style="margin-left: 35px; float: left" ImageUrl="~/Styles/Images/flags/Argentina.png"
                        Height="24px" Width="24px" runat="server"  />
                    <asp:TextBox ID="txtJogo58Time2" data-rank="1A2B" runat="server" 
                        Style="float: left; margin-left: 5px;"></asp:TextBox><span class="f"></span></div>
            </div>
            ...
            <div class="ks ks-sf ks-1A2B1C2D1E2F1G2H rtxt" title="Semi-finals">
                ...
                <div class="rtxt team ks-1A2B1C2D-w">
                    <asp:Image ID="ImgJogo60Time1" Style="margin-left: 35px; float: left" ImageUrl="~/Styles/Images/flags/Argentina.png"
                        Height="24px" Width="24px" runat="server"  />
                    <asp:TextBox ID="txtJogo60Time1" data-rank="1A2B" runat="server" 
                        Style="float: left; margin-left: 5px;"> </asp:TextBox><span class="f"></span></div>
                <div class="rtxt team ks-1E2F1G2H-w">
                    <asp:Image ID="ImgJogo60Time2" Style="margin-left: 35px; float: left" ImageUrl="~/Styles/Images/flags/Argentina.png"
                        Height="24px" Width="24px" runat="server"  />
                    <asp:TextBox ID="txtJogo60Time2" data-rank="1A2B" runat="server" 
                        Style="float: left; margin-left: 5px;"> </asp:TextBox><span class="f"></span></div>
            </div>
            ...
            <div class="ks ks-3RD" style="margin:0; padding:0;" title="Match for third place">
                   <center><b><a style="font-size:16px; margin:0; padding:0;">Terceiro lugar</a></b></center>
                <table width="100%" style="color: Black">
                    <tr>
                        <td align="right">
                            <asp:Label ID="lblJogo62Time1" runat="server"  Text="Label"
                                CssClass="n"></asp:Label>
                        </td>
                        <td align="center">
                        ...
                        <td align="left">
                            <asp:Label ID="lblJogo62Time2" runat="server"  Text="Label"
                                CssClass="n"></asp:Label>
                        </td>
                    </tr>
                </table>
            ...
            <div class="ks ks-FINAL ks-1A2B1C2D1E2F1G2H1B2A1D2C1F2E1H2G" title="Final">
                <%--<h2 style="padding:0; margin:0">
                    Final</h2>--%>
                    <center><b><a style="font-size:16px; margin:0; padding:0;">Final</a></b></center>
                <table width="100%" style="color: Black;">
                    <tr>
                        <td align="right">
                        ...
                        <td align="left">
                            <asp:Label ID="lblJogo63Time2" runat="server"  Text="Label"
                                CssClass="n"></asp:Label>
                        </td>
                    </tr>
                </table>
